 ...
 */
export const remote = async function (params: RemoteOptions, remoteModifier?: Function): Promise<Browser> {
    ...
    const instance: Browser = await ProtocolDriver.newSession(params, modifier, prototype, wrapCommand)
...
export const attach = async function (attachOptions: AttachOptions): Promise<Browser> {
    /**
    ...
    const ProtocolDriver = (await import(automationProtocol)).default
    return ProtocolDriver.attachToSession(params, undefined, prototype, wrapCommand) as Browser
}
